...
###############################################
echo "R DM_list_"$id_WMO "--vanilla < WRITE_DM_BP_XX.R" 	> lance_DM_BP_XX.sh
echo "for i in \`ls -1 $WORK_DIR/B*\`"  			>> lance_DM_BP_XX.sh
echo "do"							>> lance_DM_BP_XX.sh
echo "j=\`echo \$i | sed s/BR/BD/ | sed s/WORK/DM/\`" 		>> lance_DM_BP_XX.sh
echo  "cp \$i \$j"						>> lance_DM_BP_XX.sh
echo  "done"							>> lance_DM_BP_XX.sh
chmod +x lance_DM_BP_XX.sh
...
echo "./lance_DM_BP_XX.sh"
echo "" 
echo "If it is not, go back ./to Fill_DM_BP_XX.sh"
echo " or contact me :"
