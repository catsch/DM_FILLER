#' DOXY_to_PPOX
#'
#' This function convert oxygen concentration in µmol/kg into
#'  partial pressure oxygen in dbar according to Bittig et al.
#'  SCOR WG 142 https://doi.org/10.13155/45915
#' @param PRES_DOXY vector of pressure measured at the same
#'  time as oxygen (numeric)
#' @param TEMP_DOXY vector of temperature values at the oxygen pressure level
#' @param PSAL_DOXY vector of salinity values at the oxygen pressure level
#' @param DOXY_DOXY vector of oxygen values in µmol/kg
#'  at the oxygen pressure level
#'
#' @return vector of oxygen values in dbar (numeric)
#' 
#' @export
#'
